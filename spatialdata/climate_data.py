...
class ClimateDataDownload(object):
    ...
    def download_weather_information(self, weather_variables:Dict, suffix_output_folder:str = None, export_as_netcdf: bool = False, ncores: int = 0, version = '2_0'):
        ...
        downloader_config = {
            ...
            'relative_humidity_09': {'func': self._get_relative_humidity, 'params': {'time': ['09_00']}}, 
    ...
    def _get_relative_humidity_derived(self, mission:str = None, urlhost:str = None, output_path:str = None, statistic:str = "tmax", ncores:int = 10, version:str = '2_0', **kwargs):
        ...
        output_path : str
            The directory to save the downloaded data.
        statistic : str
            The statistic to download (e.g., 'hrmax', 'hrmin').
        ...
        if mission == 'agera5' and urlhost == 'agera5':
            summ_statistic = {
                'hrmax':["24_hour_maximum"],
                'hrmin': ["24_hour_minimum"],
            ...
            return self._download_agera5_variable(variable='2m_relative_humidity_derived', statistic=summ_statistic[key_found],
                                                  output_path=output_path, ncores=ncores, version=version)
        else:
            return None
